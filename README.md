...
| `/mop-ui` | 基于产品设计文档生成设计系统文档（`docs/design-system.md`）和交互式 HTML/CSS/SVG 原型（`docs/prototype/`），与用户迭代至满意后打开浏览器预览 |
| `/mop-tech` | 基于产品设计和 UI 原型生成技术设计文档（`docs/tech-design.md`），包含技术选型、系统架构、数据模型和 API 设计 |
